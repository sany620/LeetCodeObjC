...
+ (CBNavigationController*)findTopmostNavigationController:(UIWindow*)window {
    ...
    CBNavigationController *navi = [CBNavigationController cast:[expectView viewController]];
    return navi;
}

+ (CBNavigationController*)findTopmostNavigationController {
...
+ (void)push:(UIViewController*)controller animated:(BOOL)animated {
    CBNavigationController *navi = [self findTopmostNavigationController];
